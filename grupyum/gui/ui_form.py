...
class Ui_Grupy1(object):
    def setupUi(self, Grupy1):
        ...
        self.pushButton = QPushButton(Grupy1)
        self.pushButton.setObjectName(u"pushButton")
        self.pushButton.setGeometry(QRect(200, 10, 80, 23))
        self.listWidget = QListWidget(Grupy1)
        QListWidgetItem(self.listWidget)
        QListWidgetItem(self.listWidget)
        self.listWidget.setObjectName(u"listWidget")
        self.listWidget.setGeometry(QRect(10, 40, 256, 192))
        self.checkBox = QCheckBox(Grupy1)
        self.checkBox.setObjectName(u"checkBox")
        self.checkBox.setGeometry(QRect(60, 270, 83, 21))
        self.checkBox_2 = QCheckBox(Grupy1)
        self.checkBox_2.setObjectName(u"checkBox_2")
        self.checkBox_2.setGeometry(QRect(170, 270, 83, 21))
        ...
        self.spinBox.setGeometry(QRect(510, 130, 51, 23))
        self.spinBox.setMaximum(255)
        self.spinBox.setValue(120)
        self.spinBox_2 = QSpinBox(Grupy1)
        self.spinBox_2.setObjectName(u"spinBox_2")
        self.spinBox_2.setGeometry(QRect(510, 160, 51, 23))
        self.spinBox_2.setMaximum(255)
        self.spinBox_2.setValue(255)
        self.spinBox_3 = QSpinBox(Grupy1)
        self.spinBox_3.setObjectName(u"spinBox_3")
        self.spinBox_3.setGeometry(QRect(450, 130, 51, 23))
        self.spinBox_3.setMaximum(255)
        self.spinBox_4 = QSpinBox(Grupy1)
        self.spinBox_4.setObjectName(u"spinBox_4")
        self.spinBox_4.setGeometry(QRect(450, 160, 51, 23))
        self.spinBox_4.setMaximum(255)
        self.spinBox_4.setValue(140)
        self.spinBox_5 = QSpinBox(Grupy1)
        self.spinBox_5.setObjectName(u"spinBox_5")
        self.spinBox_5.setGeometry(QRect(390, 130, 51, 23))
        self.spinBox_5.setMaximum(255)
        self.spinBox_5.setValue(0)
        self.spinBox_6 = QSpinBox(Grupy1)
        self.spinBox_6.setObjectName(u"spinBox_6")
        self.spinBox_6.setGeometry(QRect(390, 160, 51, 23))
        self.spinBox_6.setMaximum(255)
        self.spinBox_6.setValue(140)
        ...
        self.radioButton = QRadioButton(Grupy1)
        self.radioButton.setObjectName(u"radioButton")
        self.radioButton.setGeometry(QRect(330, 380, 99, 21))
        ...
        self.doubleSpinBox = QDoubleSpinBox(Grupy1)
        self.doubleSpinBox.setObjectName(u"doubleSpinBox")
        self.doubleSpinBox.setGeometry(QRect(700, 120, 62, 23))
        self.doubleSpinBox.setMaximum(1.000000000000000)
        self.doubleSpinBox.setValue(0.010000000000000)
        self.listWidget_2 = QListWidget(Grupy1)
        QListWidgetItem(self.listWidget_2)
        QListWidgetItem(self.listWidget_2)
        self.listWidget_2.setObjectName(u"listWidget_2")
        self.listWidget_2.setGeometry(QRect(885, 80, 331, 361))
        ...
        self.spinBox_7 = QSpinBox(Grupy1)
        self.spinBox_7.setObjectName(u"spinBox_7")
        self.spinBox_7.setGeometry(QRect(390, 270, 51, 23))
        self.spinBox_7.setMaximum(255)
        self.spinBox_7.setValue(0)
        self.spinBox_8 = QSpinBox(Grupy1)
        self.spinBox_8.setObjectName(u"spinBox_8")
        self.spinBox_8.setGeometry(QRect(450, 270, 51, 23))
        self.spinBox_8.setMaximum(255)
        self.spinBox_9 = QSpinBox(Grupy1)
        self.spinBox_9.setObjectName(u"spinBox_9")
        self.spinBox_9.setGeometry(QRect(390, 300, 51, 23))
        self.spinBox_9.setMaximum(255)
        self.spinBox_9.setValue(255)
        self.spinBox_10 = QSpinBox(Grupy1)
        self.spinBox_10.setObjectName(u"spinBox_10")
        self.spinBox_10.setGeometry(QRect(450, 300, 51, 23))
        self.spinBox_10.setMaximum(255)
        self.spinBox_10.setValue(255)
        self.spinBox_11 = QSpinBox(Grupy1)
        self.spinBox_11.setObjectName(u"spinBox_11")
        self.spinBox_11.setGeometry(QRect(510, 270, 51, 23))
        self.spinBox_11.setMaximum(255)
        self.spinBox_11.setValue(0)
        self.spinBox_12 = QSpinBox(Grupy1)
        self.spinBox_12.setObjectName(u"spinBox_12")
        self.spinBox_12.setGeometry(QRect(510, 300, 51, 23))
        self.spinBox_12.setMaximum(255)
        self.spinBox_12.setValue(110)
    ...
    def retranslateUi(self, Grupy1):
        ...
        self.pushButton.setText(QCoreApplication.translate("Grupy1", u"Import", None))
        ...
        self.checkBox.setText(QCoreApplication.translate("Grupy1", u"Yes", None))
        self.checkBox_2.setText(QCoreApplication.translate("Grupy1", u"No", None))
        ...
        self.radioButton.setText(QCoreApplication.translate("Grupy1", u"Canny", None))
